...
const ViewSongsPremium = () => {
  ...
  const handleSelectSong = async (song) => {
    ...
    if (updatedSelectedSongs.has(song.songId)) {
        updatedSelectedSongs.delete(song.songId); // Remove song if already selected
    } else {
        updatedSelectedSongs.add(song.songId); // Add song if not already selected
    }
    setSelectedSongs(updatedSelectedSongs);

    // Update playing song logic
    ...
    try {
      ...
      // Make a request to the updated endpoint with the list of selected songs
...
export default ViewSongsPremium;
